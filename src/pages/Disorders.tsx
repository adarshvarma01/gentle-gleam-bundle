...
import { Brain, CloudRain, Zap, AlertCircle, TrendingUp, Heart } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-8">
                ...
                >
                  <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="lg:w-1/3">
                      <div className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br ${disorder.color} mb-4`}>
                        <Icon className="w-7 h-7 text-white" />
                      </div>
                      <h2 className="text-2xl font-bold mb-3">{disorder.name}</h2>
        ...
        <section className="py-12">
          <div className="bg-secondary rounded-3xl p-8 text-center">
            ...
            <div className="inline-flex items-center gap-2 px-6 py-3 rounded-xl gradient-primary text-white font-medium">
              <span>Crisis Helpline: 988 (US)</span>
            </div>
          </div>
        </section>
      </div>
